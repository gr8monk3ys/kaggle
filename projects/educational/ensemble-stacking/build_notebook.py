...
# ── Cell 7: Why Ensembles Win Header ─────────────────────────────────────────
cells.append(
    md(
        '<a id="2"></a>\n'
        "## 2. Why Ensembles Win\n"
...
# ── Cell 8: Bias-Variance Visualization ─────────────────────────────────────
cells.append(
    code(
...
# ── Cell 9: Diversity visualization ─────────────────────────────────────
cells.append(
    code(
...
# ── Cell 10: Historical Kaggle wins ──────────────────────────────────────
cells.append(
    md(
...
# ── Cell 13: sklearn Bagging header ────────────────────────────────────
cells.append(
    md(
...
# ── Cell 18: AdaBoost visualization ─────────────────────────────────────
cells.append(
    code(
...
# ── Cell 19: Gradient Boosting step-by-step ─────────────────────────────
cells.append(
    md(
...
# ── Cell 20: Gradient Boosting LR effect ─────────────────────────────
cells.append(
    code(
...
# ── Cell 21: XGB vs LGBM vs CatBoost ────────────────────────────────
cells.append(
    md(
...
# ── Cell 30: Correlation and ensemble quality ────────────────────────
cells.append(
    code(
...
# ── Cell 38: Snapshot Ensembles Header ──────────────────────────────
cells.append(
    md(
        '<a id="7"></a>\n'
...
# ── Cell 39: Cosine annealing visualization ────────────────────────
cells.append(
    code(
...
# ── Cell 40: Snapshot ensemble simulation ────────────────────────────
cells.append(
    code(
...
# ── Cell 41: Knowledge Distillation Header ───────────────────────────
cells.append(
    md(
        '<a id="8"></a>\n'
...
# ── Cell 42: Knowledge Distillation code ─────────────────────────────
cells.append(
    code(
...
# ── Cell 44: Competition Pipeline Header ─────────────────────────────
cells.append(
    md(
        '<a id="9"></a>\n'
...
# ── Cell 48: Diversity Analysis Header ───────────────────────────────
cells.append(
    md(
        '<a id="10"></a>\n'
...
# ── Cell 49: Diversity analysis code ─────────────────────────────────
cells.append(
    code(
...
# ── Cell 50: When adding models helps vs hurts ───────────────────────
cells.append(
    code(
