...
'already running tight C loops, like string scans and plain window means. Exact\n'
'multipliers vary per Kaggle machine (2-4 vCPUs), which is precisely why this\n'
'notebook measures instead of quoting someone else\'s numbers — fork it and\n'
'your chart will show *your* hardware.'
))
