...
# ── 4. Setup & Imports ────────────────────────────────────────────────────
cells.append(md(L('<a id="setup"></a>', "## 1. Setup & Imports")))
...
cells.append(md(L("### Custom PyTorch Dataset")))
...
cells.append(md(L("### Albumentations Pipeline")))
...
cells.append(md(L("### Training Curves")))
...
cells.append(md(L("### Test-Time Augmentation (TTA)")))
...
cells.append(md(L("### Morphological Post-Processing")))
...
cells.append(md(L("### Multi-Scale Inference & Pseudo Labeling")))
...
cells.append(md(L("### Run-Length Encoding (RLE) for Submission")))
