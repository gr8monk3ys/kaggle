...
'![Target](https://img.shields.io/badge/Target-99%25%2B_val_accuracy-blue)\n'
...
'\n'
'The parameter counts below are exact -- they come straight out of the model definitions above.\n'
'The accuracy column is **expected** rather than measured: it is what each of these\n'
'configurations typically reaches on MNIST, and it is what the training cells above will print\n'
'for real once you run them. Your own run is the number that counts; if it lands somewhere else,\n'
'that is worth a comment below.\n'
'\n'
'| Model | Expected Val Accuracy | Parameters | Notes |\n'
'|-------|-------------|------------|-------|\n'
