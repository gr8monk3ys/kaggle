...
'|----------|---------|----------|\n'
'| Tree growth | Level-wise | Leaf-wise (faster, more accurate) |\n'
'| Speed | Moderate | Very fast |\n'
'| Memory | Higher | Lower |\n'
'| Categorical | Needs encoding | Native support |\n'
'| Regularization | L1/L2 | L1/L2 + min_child_samples |\n'
'\n'
...
'- Early stopping is ideal but we use fixed n_estimators for simplicity here'
))
...
'### Our Approach\n'
'\n'
'1. Generate OOF predictions from XGBoost and LightGBM (5-fold)\n'
'2. **Simple blend:** 50/50 average as a strong baseline\n'
'3. **Optimal blend:** Use `scipy.optimize.minimize` to find best weights\n'
'4. Final predictions: fit on full train, predict test\n'
'\n'
'For a full stacking pipeline, you would add Ridge OOF as a third component -- often improves RMSE by 0.002-0.005.'
))
