...
Usage
-----
    python3 -m kaggle_portfolio.notebooks.competition_entry spaceship-titanic
    python3 -m kaggle_portfolio.notebooks.competition_entry spaceship-titanic --gpu
    python3 -m kaggle_portfolio.notebooks.competition_entry spaceship-titanic --push
...
def competition_entry_dir(slug: str) -> Path:
    return ROOT / COMPETITIONS_DIR / slug
