...
Usage
-----
    python3 -m kaggle_portfolio.ops.stale_content_detector                    # print report
    python3 -m kaggle_portfolio.ops.stale_content_detector --max-nb-age 30    # custom notebook threshold
    python3 -m kaggle_portfolio.ops.stale_content_detector --max-ds-age 60    # custom dataset threshold
    python3 -m kaggle_portfolio.ops.stale_content_detector --today 2026-03-02 # override today for testing
    python3 -m kaggle_portfolio.ops.stale_content_detector --json             # output JSON instead of markdown
