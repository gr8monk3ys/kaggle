...
Usage
-----
    python3 -m kaggle_portfolio.datasets.dataset_explore_generator --dir datasets/credit-card-fraud
    python3 -m kaggle_portfolio.datasets.dataset_explore_generator --all
    python3 -m kaggle_portfolio.datasets.dataset_explore_generator --all --push
