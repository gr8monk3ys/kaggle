...
Usage
-----
    python3 -m kaggle_portfolio.datasets.dataset_optimizer                    # generate READMEs only
    python3 -m kaggle_portfolio.datasets.dataset_optimizer --push             # generate + re-upload datasets
    python3 -m kaggle_portfolio.datasets.dataset_optimizer --dir datasets/job-postings  # single dataset
