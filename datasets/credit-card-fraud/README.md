...
`finance`, `business`, `classification`, `anomaly detection`, `tabular`, `binary classification`
...
**Rows:** 200,000  |  **Columns:** 36  |  **Size:** 59,363.2 KB

| Column | Type | Null% | Unique | Sample values |
|--------|------|-------|--------|---------------|
| `transaction_id` | string | 0.0% | 200,000 | `TXN000000`, `TXN000001`, `TXN000002` |
| `Time` | integer | 0.0% | 118,499 | `21669`, `154552`, `108347` |
| `V1` | float | 0.0% | 194,531 | `-1.674946`, `0.457052`, `-0.869588` |
| `V2` | float | 0.0% | 194,512 | `0.4876`, `0.048544`, `1.381336` |
| `V3` | float | 0.0% | 194,463 | `1.175017`, `-0.013781`, `0.549428` |
| `V4` | float | 0.0% | 194,528 | `0.635452`, `0.622927`, `0.540193` |
| `V5` | float | 0.0% | 194,568 | `-0.521807`, `2.308919`, `-0.715576` |
| `V6` | float | 0.0% | 194,383 | `0.254763`, `-0.487454`, `-1.626004` |
| `V7` | float | 0.0% | 194,581 | `0.059483`, `-0.169976`, `-1.458558` |
| `V8` | float | 0.0% | 194,425 | `1.010286`, `-1.569339`, `1.64164` |
| `V9` | float | 0.0% | 194,376 | `-1.553294`, `0.179202`, `0.726559` |
| `V10` | float | 0.0% | 194,533 | `-1.505219`, `-0.692094`, `-0.764346` |
| `V11` | float | 0.0% | 194,493 | `1.432725`, `-1.237974`, `0.704293` |
| `V12` | float | 0.0% | 194,564 | `-0.75462`, `-2.084791`, `0.907533` |
| `V13` | float | 0.0% | 194,517 | `-0.249966`, `0.041788`, `-1.861304` |
| `V14` | float | 0.0% | 194,538 | `-0.355055`, `-0.261141`, `-0.724303` |
| `V15` | float | 0.0% | 194,425 | `0.257343`, `-0.682517`, `1.605375` |
| `V16` | float | 0.0% | 194,432 | `-1.748765`, `-0.187089`, `-0.928111` |
| `V17` | float | 0.0% | 194,516 | `-0.919773`, `-0.420935`, `-0.181425` |
| `V18` | float | 0.0% | 194,548 | `-1.196052`, `-1.383653`, `0.951308` |
| `V19` | float | 0.0% | 194,505 | `-0.141891`, `-0.727302`, `-0.797672` |
| `V20` | float | 0.0% | 194,352 | `1.214874`, `0.597476`, `-1.867054` |
| `V21` | float | 0.0% | 194,481 | `-0.606343`, `1.752873`, `1.744513` |
| `V22` | float | 0.0% | 194,420 | `-0.68923`, `-0.845305`, `-0.886995` |
| `V23` | float | 0.0% | 194,482 | `-0.473771`, `0.38852`, `0.03757` |
| `V24` | float | 0.0% | 194,503 | `0.203366`, `-0.753456`, `-0.604088` |
| `V25` | float | 0.0% | 194,502 | `1.241134`, `-0.596844`, `-1.291588` |
| `V26` | float | 0.0% | 194,482 | `-0.643846`, `-0.223539`, `-1.484245` |
| `V27` | float | 0.0% | 194,515 | `-0.217364`, `-0.769639`, `0.500329` |
| `V28` | float | 0.0% | 194,538 | `0.690976`, `-0.352037`, `1.085212` |
| `Amount` | float | 0.0% | 29,310 | `19.49`, `63.58`, `1.13` |
| `merchant_category` | string | 0.0% | 8 | `grocery`, `restaurant`, `online` |
| `hour_of_day` | integer | 0.0% | 24 | `6`, `22`, `17` |
| `day_of_week` | integer | 0.0% | 2 | `0`, `1` |
