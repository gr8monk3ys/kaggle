...
YEAR_IMPROVEMENT = {
    ...
    "Python": {
        ...
        2024: 0.90,
        2025: 0.85,
    },  # Python getting faster (3.11+, JIT)
}
# Default: slight improvement for unlisted languages
DEFAULT_YEAR_IMPROVEMENT = {
    2020: 1.10,
    2021: 1.07,
    2022: 1.05,
    2023: 1.03,
...
def main():
    ...
    for language in LANGUAGES:
        for benchmark in BENCHMARKS:
            for year in range(2020, 2026):
                ...
                rec["execution_time_ms"] = compute_execution_time(
                    language, benchmark, year, cpu_cores
                )
    ...
    for lang in sorted(LANGUAGES):
        times = [
            ...
            for r in records
            if r["language"] == lang
            and r["benchmark_name"] == "fibonacci"
            and r["cpu_cores"] == 1
            and r["year"] == 2025
        ]
        if times:
