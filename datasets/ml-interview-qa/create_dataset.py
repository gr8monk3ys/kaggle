...
====================================================
Writes the hand-curated bank of ML/DS interview questions (119 questions
across 10 categories) to ml_interview_questions.csv.

Every question, answer, difficulty label, and topic tag below was written
by hand — there is no templated or randomly-generated content. The row
order is shuffled deterministically so categories are interleaved.
...
STATISTICS_QUESTIONS = [
    ...
    (
        ...
        ["estimation", "shrinkage", "high-dimensional statistics"],
        "hard",
    ),
    (
        ...
        ["estimation", "probability", "mathematical statistics"],
        "hard",
    ),
    (
        ...
        ["estimation", "clustering", "latent variables"],
        "hard",
    ),
    (
        ...
        ["mathematical statistics", "estimation", "information theory"],
        "hard",
    ),
    (
        ...
        ["information theory", "estimation", "optimization"],
        "hard",
    ),
    (
...
ML_THEORY_QUESTIONS = [
    ...
    (
        ...
        ["tree models", "classification", "regression"],
        "easy",
    ),
    (
    ...
    (
        ...
        ["classification metrics", "evaluation", "imbalanced data"],
        "medium",
    ),
    (
    ...
    (
        ...
        ["linear models", "optimization", "computational complexity"],
        "hard",
    ),
    (
        ...
        ["learning theory", "generalization", "computational complexity"],
        "hard",
    ),
    (
    ...
    (
        ...
        ["SVM", "optimization", "kernel methods"],
        "hard",
    ),
    (
        ...
        ["gaussian processes", "bayesian methods", "regression"],
        "hard",
    ),
    (
        ...
        ["neural networks", "optimization", "backpropagation"],
        "hard",
    ),
]
...
DEEP_LEARNING_QUESTIONS = [
    ...
    (
        ...
        ["normalization", "neural networks", "training"],
        "easy",
    ),
    (
    ...
    (
        ...
        ["transformers", "language models", "NLP"],
        "medium",
    ),
    (
    ...
    (
        ...
        ["transfer learning", "fine-tuning", "practical ML"],
        "medium",
    ),
    (
        ...
        ["generative models", "latent variables", "variational inference"],
        "medium",
    ),
    (
        ...
        ["model compression", "deployment", "training"],
        "medium",
    ),
    (
    ...
    (
        ...
        ["attention", "transformers", "optimization"],
        "hard",
    ),
    (
        ...
        ["pruning", "network architecture", "optimization"],
        "hard",
    ),
    (
        ...
        ["generative models", "diffusion", "image generation"],
        "hard",
    ),
    (
        ...
        ["architecture search", "AutoML", "optimization"],
        "hard",
    ),
    (
...
NLP_QUESTIONS = [
    ...
    (
        ...
        ["text representation", "information retrieval"],
        "easy",
    ),
    (
    ...
    (
        ...
        ["text generation", "decoding", "search"],
        "medium",
    ),
    (
        ...
        ["attention", "sequence models", "translation"],
        "medium",
    ),
    (
    ...
    (
        ...
        ["retrieval", "language models", "knowledge-grounded"],
        "medium",
    ),
    (
        ...
        ["language models", "scaling", "training"],
        "hard",
    ),
    (
        ...
        ["alignment", "reinforcement learning", "language models"],
        "hard",
    ),
    (
        ...
        ["language models", "few-shot learning", "transformers"],
        "hard",
    ),
    (
        ...
        ["language models", "architecture", "scaling"],
        "hard",
    ),
]
...
CV_QUESTIONS = [
    ...
    (
        ...
        ["data augmentation", "training", "regularization"],
        "easy",
    ),
    (
    ...
    (
        ...
        ["ResNet", "architecture", "deep networks"],
        "medium",
    ),
    (
        ...
        ["object detection", "real-time", "architecture"],
        "medium",
    ),
    (
        ...
        ["vision transformer", "architecture", "attention"],
        "medium",
    ),
    (
        ...
        ["object detection", "multi-scale", "architecture"],
        "medium",
    ),
    (
        ...
        ["convolution", "architecture", "geometric deep learning"],
        "hard",
    ),
    (
        ...
        ["3D vision", "neural rendering", "volumetric rendering"],
        "hard",
    ),
    (
...
SYSTEM_DESIGN_QUESTIONS = [
    ...
    (
        ...
        ["feature engineering", "MLOps", "infrastructure"],
        "easy",
    ),
    (
        ...
        ["recommendation systems", "system design", "ranking"],
        "medium",
    ),
    (
        ...
        ["fraud detection", "real-time systems", "streaming"],
        "medium",
    ),
    (
...
SQL_QUESTIONS = [
    ...
    (
        ...
        ["window functions", "subqueries", "ranking"],
        "medium",
    ),
    (
    ...
    (
        ...
        ["sessionization", "window functions", "analytics"],
        "hard",
    ),
    (
        ...
        ["retention", "cohort analysis", "product analytics"],
        "hard",
    ),
]
...
PYTHON_QUESTIONS = [
    ...
    (
        ...
        ["concurrency", "performance", "CPython"],
        "medium",
    ),
    (
        ...
        ["decorators", "functions", "design patterns"],
        "medium",
    ),
    (
    ...
    (
        ...
        ["metaclasses", "OOP", "design patterns"],
        "hard",
    ),
    (
        ...
        ["PyTorch", "data loading", "performance"],
        "hard",
    ),
]
...
FEATURE_ENGINEERING_QUESTIONS = [
    (
        ...
        ["missing data", "imputation", "data preprocessing"],
        "easy",
    ),
    (
    ...
    (
        ...
        ["scaling", "normalization", "data preprocessing"],
        "easy",
    ),
    (
        ...
        ["target encoding", "categorical features", "leakage"],
        "medium",
    ),
    (
        ...
        ["time features", "temporal data", "feature engineering"],
        "medium",
    ),
    (
        ...
        ["feature interactions", "polynomial features", "non-linearity"],
        "medium",
    ),
    (
        ...
        ["recommendation systems", "feature engineering", "user modeling"],
        "hard",
    ),
    (
        ...
        ["data leakage", "validation", "feature engineering"],
        "hard",
    ),
]
...
AB_TESTING_QUESTIONS = [
    ...
    (
        ...
        ["power analysis", "sample size", "statistics"],
        "easy",
    ),
    (
        ...
        ["experimentation", "statistical errors", "methodology"],
        "medium",
    ),
    (
        ...
        ["bayesian statistics", "hypothesis testing", "methodology"],
        "medium",
    ),
    (
        ...
        ["causal inference", "quasi-experiments", "marketplace experimentation"],
        "hard",
    ),
    (
        ...
        ["interference", "network effects", "causal inference"],
        "hard",
    ),
]
