...
| Property | Value |
|---|---|
| Main jobs table | `jobs.csv` |
| Jobs | `36,000` |
| Companies | `280` |
| Job-skill edges | `318,014` |
| Salary benchmark slices | `618` |
| Monthly skill trend rows | `1,080` |
| Regions | `North America`, `Europe`, `APAC` |
| Role families | `8` |

Column dictionaries below use representative sample values from the generated files. For very large tables, sample-based unique counts may be lower than the full dataset totals.
...
- Salary prediction and compensation benchmarking
- Skill-demand trend analysis across 2024-2026
- Job-to-skill graph ML and recommendation systems
- Role classification from descriptions, skills, and company context
- Multi-table analytics dashboards for AI and data hiring
