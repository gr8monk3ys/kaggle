...
Usage
-----
    python3 metadata_tracker.py snapshot              # take a snapshot
    python3 metadata_tracker.py snapshot --dry-run    # preview without writing
    python3 metadata_tracker.py annotate feature-engineering "Updated title for SEO"
    python3 metadata_tracker.py report                # show metadata changes vs votes
    python3 metadata_tracker.py report --json         # machine-readable report
